      ...
      <form action="{{ route('admin.plans.update', $plan) }}" method="post" class="space-y-6">
        ...
        <div class="space-y-1 md:space-y-0 md:flex md:items-center">
          ...
          <div class="md:w-3/5 relative">
            ...
            <input type="text" id="price" name="price" value="{{ old('price', $plan->price) }}" class="block border border-gray-200 rounded pl-10 py-2 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" placeholder="请输入价格" />
          </div>
        </div>
