...
@section('breadcrumb')
  <x-breadcrumb.list>
    ...
    <x-breadcrumb.item href="{{ route('admin.records.collect') }}">收藏记录</x-breadcrumb.item>
...
@section('content')
  <div class="flex flex-col rounded shadow-sm bg-white overflow-hidden">
    <div class="py-4 px-5 lg:px-6 flex-grow w-full">
      <form action="{{ route('admin.records.collect') }}" method="get" class="space-y-3 sm:space-y-0 sm:flex sm:items-center sm:space-x-4">
