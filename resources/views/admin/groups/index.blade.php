            ...
            @foreach($groups as $group)
              <tr class="border-t border-gray-100">
                ...
                <td class="py-3 px-6 text-center">
                  <span class="inline-block rounded w-5 h-5 {{ \App\Models\CardGroup::$bgColorMap[$group->color] }}" title="{{ $group->color }}"></span>
                </td>
                <td class="py-3 px-6 text-center">
                ...
                <td class="py-3 px-6 text-center">
                  <a href="{{ route('admin.records.unlock', ['group_id' => $group->id]) }}" class="inline-flex justify-center items-center space-x-1 border font-semibold focus:outline-none px-2 py-1 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
